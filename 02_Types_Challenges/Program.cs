...
System.Console.WriteLine("How do you say hello?");
string saying = Console.ReadLine();
System.Console.WriteLine("Your favorite way is " + saying);

decimal whatsInThere = 10.1m;
System.Console.WriteLine(whatsInThere);
